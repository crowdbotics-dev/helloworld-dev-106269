"""
Django settings for helloworld_dev_106269 project.
...
ROOT_URLCONF = 'helloworld_dev_106269.urls'
...
WSGI_APPLICATION = 'helloworld_dev_106269.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "helloworld_dev_106269 API",
    "DESCRIPTION": "API documentation for helloworld_dev_106269 App",
    "VERSION": "v1",
}
